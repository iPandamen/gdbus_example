...
static void handle_method_call (GDBusConnection       *connection,
  ...
  } else if(g_strcmp0(object_path, APP_OBJECT_PATH "/service0/char3") == 0) {
    // Report notify
    if(g_strcmp0(method_name, "ReadValue") == 0) {
  ...
  } else if(g_strcmp0(object_path, APP_OBJECT_PATH "/service0/char3/descriptor0") == 0) {

  } else if(g_strcmp0(object_path, APP_OBJECT_PATH "/service0/char4") == 0) {
    // Report write
  ...
  } else if(g_strcmp0(object_path, APP_OBJECT_PATH "/service0/char4/descriptor0") == 0) {

  } else if(g_strcmp0(object_path, APP_OBJECT_PATH "/service0/char5") == 0) {
